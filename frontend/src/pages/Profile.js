            ...
            <div style={{ width: '75%', margin: '0 auto' }}>
              ...
              <div className="m-5">
                <Container className="m-3">
                  <Row>
                    <Col>
                      <h5>zID: {this.centralState.user.zID}</h5>
                    </Col>
                  </Row>
                </Container>
                <Container className="m-3">
                  <Row>
                    <Col className="col-md-auto">
                      <h5>Full Name: {this.centralState.user.fullName}</h5>
                    </Col>
                    <Col className="col-md-auto">
                      ...
                      <ChangeFullName
                        show={this.state.fullNameShow}
                        handleClose={this.fullNameClose}
                      />
                    </Col>
                  </Row>
                </Container>
                <Button
                  className="m-3"
                  variant="danger"
                  onClick={this.passwordOpen}
                >
                  Change Password
                </Button>
                <ChangePassword
                  show={this.state.passwordShow}
                  handleClose={this.passwordClose}
                />
              </div>
              <div>
                <h5>Submission:</h5>
                ...
                >
                  {this.centralState.projects
                    .filter(
                      (project) =>
                        project.id === this.centralState.user.project,
                    )
                    .map((project) => (
              ...
              <div>
                ...
                >
                  {this.centralState.projects
                    .filter((project) =>
                      this.centralState.user.votes.includes(project.id),
                    )
                    .map((project) => (
                      <ProjectCard key={project.id} project={project} />
                    ))}
