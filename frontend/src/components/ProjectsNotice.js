      ...
      <>
        {this.centralState.user === null && (
          <Alert className="m-3" variant="warning">
            ...
            {this.centralState.projectDeadline}. Voting closes on{' '}
        ...
        {this.centralState.user !== null &&
          this.centralState.user.votes.length < 3 && (
            <Alert className="m-3" variant="success">
              You have {3 - this.centralState.user.votes.length} vote
              {this.centralState.user.votes.length !== 2 && 's'} remaining.
